...
["46.18.0.0",     "255.255.128.0"],   // /17 — Zain Jordan (AS48832) ⭐ شبكة زين عالية الجودة (32,768 IP)
["178.20.128.0",  "255.255.128.0"],   // /17 — Zain Jordan (AS48832) ⭐ نطاق زين إضافي منخفض التأخير (32,768 IP)
["5.21.0.0",      "255.255.128.0"],   // /17 — Orange Jordan (AS8376) ⭐ شبكة أورنج الأردن (32,768 IP)
["94.249.128.0",  "255.255.128.0"]   // /17 — Umniah (AS9038) ⭐ شبكة أمنية الأردن (32,768 IP)
];
