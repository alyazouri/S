...
["176.29.0.0",   "255.255.0.0"],   // /16 — Zain Jordan (AS48832) ⭐ شبكة زين الأردن الرئيسية (65,536 IP)
["82.212.0.0",   "255.255.0.0"],   // /16 — Orange Jordan (AS8376) ⭐ شبكة أورنج الأردن الرئيسية (65,536 IP)
["188.247.0.0",  "255.255.0.0"],   // /16 — Orange Jordan (AS8376) ⭐ نطاق إضافي لأورنج الأردن (65,536 IP)
["31.9.0.0",     "255.255.0.0"],   // /16 — Umniah (AS9038) ⭐ شبكة أمنية الأردن الرئيسية (65,536 IP)
["62.135.0.0",   "255.255.0.0"]   // /16 — Jordan Telecom / Orange Jordan (AS8376) ⭐ البنية الأساسية للاتصالات الأردنية (65,536 IP)
];

// ================= 3. PURE INTRA-JORDAN NETWORKS (IPV6) =================
var JORDAN_MATCH_IPV6 = [
  ["31.9.0.0",      "255.255.0.0"],     // /16
  ["37.17.224.0",   "255.255.248.0"],   // /21
  ["37.75.144.0",   "255.255.240.0"],   // /20
  ["46.18.0.0",     "255.255.128.0"],   // /17
